...
changelog_path_name=vendor/lineage/CHANGELOG.mkdn #changelog file path/name.extension
source_name="Delight Oreo" #Name to display in changelog.md top before version
# input variables end
